...
class TestEndToEndWorkflow:
    ...
    def test_ask_chain_workflow(self, mock_get_model):
        ...
        steps = ["Summarize this: $input", transform_text, "Translate to Spanish: $input"]
...
class TestErrorHandling:
    ...
    def test_invalid_action_config(self):
        ...
        with pytest.raises(ValueError):
            ActionConfig(action_type="invalid_action", parameters={"invalid": "params"})
    ...
    def test_missing_api_keys(self):
        ...
        config = ActionConfig(action_type="search_web", parameters=WebSearchParams(query="test"))
